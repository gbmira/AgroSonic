import { Text, View, Image, StyleSheet, TouchableOpacity, TouchableHighlight, TextInput, ScrollView } from 'react-native';
...
export default function Home() {
    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            ...
            <Image style={styles.imageHome} source={require('../assets/images/agricola.jpg')} />
            ...
            <Image style={styles.imageHome} source={require('../assets/images/plantafone.jpg')} />
